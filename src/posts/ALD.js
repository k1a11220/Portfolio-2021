        ...
        >
          ...
          <article className="container_article">
            ...
            <p className="font-bold font-gray">
              First, 'How to rotate chamber'. Second, 'Sealing chamber in
              rotating process'.
            </p>
          </article>
          ...
          <article className="container_article">
            ...
            <p className="font-gray" style={{ marginBottom: "0.625rem" }}>
              To rotate the chamber, our team determined to use a servo motor
              and internal gears. So we calculated the gear ratio by those
              formulas. Based on the result data we selected internal gears and
              servo motor type.
            </p>
            <p className="font-gray" style={{ marginBottom: "0.625rem" }}>
              O-ring design was not difficult. But we spent a lot of time to
              think magnetic fluid. It's not recommended to use an o-ring with
              moving parts. Because o-ring makes particles by friction.
              Particles bring the critical issue to the wafer. So we have to
              find material that meet two criteria.
            </p>
